<section id="tentang" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-16">
    <div class="grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="order-1 lg:order-2 rounded-[2.5rem] overflow-hidden aspect-[16/10] shadow-soft">
